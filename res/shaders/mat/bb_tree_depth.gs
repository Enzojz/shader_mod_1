...
void main() {
	...
	vec3 vertexToCam = camPos - vpos;

	float offset = -max(dim.x, dim.y) * .5 * scale * projView[2][2];		// TODO coordsOH?
	...
	vertices = getVerticesOH(coordsOH, heightOH, vpos, tangent, binormal, normal, scale);
